...
eagurl="https://raw.githubusercontent.com/Saturn-XVII/eaglercraft/main/stable-download/stable-download_repl.zip"
...
if [ -f "base.repl" ] && ! { [ "$REPL_OWNER" == "mr-t-2" ] && [ "$REPL_SLUG" == "mc2" ]; };
then
